...
public class ProjectsAdapter extends BaseAdapter{
    ...
    public ProjectsAdapter(Context context, ArrayList<String> username,ArrayList<Integer> profilePic,ArrayList<String> distance) {
        activity = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null){
            ...
            itemView = inflater.inflate(R.layout.collaborators_list_item, parent, false);
            postHolder = new PostHolder();
            postHolder.profile_picture = (CircleImageView) itemView.findViewById(R.id.coll_profile_picture);
            postHolder.username = (TextView) itemView.findViewById(R.id.coll_username);
            postHolder.distance = (TextView) itemView.findViewById(R.id.coll_user_distance);
